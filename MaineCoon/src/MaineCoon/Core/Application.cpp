...
// Emedded font
#include <MaineCoon/ImGui/Robot-Regular.embed>
...
static MaineCoon::Application* s_Instance = nullptr;
...
namespace MaineCoon {
    ...
    void Application::Init()
	{
		...
		// const char** extensions = glfwGetRequiredInstanceExtensions(&extensions_count);          //  Vulkan stuff
		// SetupVulkan(extensions, extensions_count);                                               //

		// Create Window Surface
		// VkSurfaceKHR surface;                                                                        //
		// VkResult err = glfwCreateWindowSurface(g_Instance, m_WindowHandle, g_Allocator, &surface);   //  Vulkan stuff
		// check_vk_result(err);                                                                        //
